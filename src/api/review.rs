...
pub async fn resolve_review(db: &DbHandle, review_id: &str, resolution: Resolution) -> Result<(), KipError> {
...
pub async fn resolve_all_review(db: &DbHandle, intent_id: &str, resolution: Resolution) -> Result<u64, KipError> {
